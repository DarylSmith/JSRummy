...
export var GamePage = (function () {
    function GamePage(navCtrl, jrummy, jrummyText, elementRef, animationCallback) {
    ...
    GamePage.prototype.scoreGameAndPlayAgain = function () {
        var result = this._jrummy.compareHands();
        if (result === "computerwon") {
            ...
            var winningPlaterStr = this._jrummy.CurrentGame.CurrentStatus == GameStatus.ComputerWon ? "Computer Won" : "Player Won";
    ...
    GamePage.prototype.moveLeftHand = function (moveIn) {
        ...
        this.leftHandInterval = setInterval(function () {
            if (index === handIndex.length - 1) {
                ...
                if (!moveIn) {
                    _this.showAnimation = 'take-stock';
                }
                else {
