...
export var GamePage = (function () {
    ...
    GamePage.prototype.ExecuteErrorRestart = function () {
    ...
    GamePage = __decorate([
        ...
        __metadata('design:paramtypes', [NavController, JRummy, JRummyText, ElementRef, AnimationCallback, DragulaService, StateManager, AudioManager])
    ], GamePage);
    return GamePage;
}());
